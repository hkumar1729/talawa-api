import type { agendaItemAttachmentsTable } from "~/src/drizzle/tables/agendaItemAttachments";
import { builder } from "~/src/graphql/builder";

export type AgendaItemAttachment =
	typeof agendaItemAttachmentsTable.$inferSelect;

export const AgendaItemAttachment = builder.objectRef<AgendaItemAttachment>(
